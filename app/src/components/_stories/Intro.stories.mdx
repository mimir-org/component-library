...
# Mimirorg design system

With this design system we want to establish reusable components and guidelines which will help its users contribute to the application in an effective manner. This component
